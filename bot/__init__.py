...
try:
    ...
    if len(AUTHOR_URL) == 0:
        AUTHOR_URL = 'https://t.me/MOVIES_ZILAA'
except KeyError:
    AUTHOR_URL = 'https://t.me/MOVIES_ZILAA'
try:
    GD_INFO = getConfig('GD_INFO')
    if len(GD_INFO) == 0:
        GD_INFO = 'Uploaded by AnuragMirror Mirror Bot'
except KeyError:
    GD_INFO = 'Uploaded by AnuragMirror Mirror Bot'
try:
    TITLE_NAME = getConfig('TITLE_NAME')
    if len(TITLE_NAME) == 0:
        TITLE_NAME = 'AnuragMirror'
except KeyError:
    TITLE_NAME = 'AnuragMirror'
try:
...
try:
    ...
    START_BTN2_URL = 'https://t.me/MIRRORLEECH_OBOT'

try:
    CREDIT_NAME = getConfig('CREDIT_NAME')
    if len(CREDIT_NAME) == 0:
        CREDIT_NAME = 'AnuragMirror'
except KeyError:
    CREDIT_NAME = 'AnuragMirror'
...
try:
    ...
    log_info("CHANNEL_USERNAME not provided! Using default @MOVIES_ZILAA")
    CHANNEL_USERNAME = "AnuragMirror"
try:
    ...
    log_info("CHANNEL_ID not provided! Using default id of @MOVIES_ZILAA")
    FSUB_CHANNEL_ID = -1001743903405
try:
