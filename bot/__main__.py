...
def start(update, context):
    buttons = ButtonMaker()
    if EMOJI_THEME is True:
        buttons.buildbutton("😎 Master", "https://t.me/Am_RoBots ")
        buttons.buildbutton("🔥 Group", "https://t.me/MOVIES_ZILAA")
    else:
        buttons.buildbutton("Master", "https://t.me/Am_RoBots ")
        buttons.buildbutton("Group", "https://t.me/MOVIES_ZILAA")
...
help_string = '''
<b><a href='https://github.com/8769ANURAG/8769ANURAG'>DipeshMirror</a></b> - The Ultimate Telegram MIrror-Leech Bot to Upload Your File & Link in Google Drive & Telegram
