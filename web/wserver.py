...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/8769Anurag/8769Anurag"><i class="fab fa-github"></i></a>
        <a href="https://t.me/MOVIES_ZILAA"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
<body>
   <!--© Designed and coded by @Am_Robots-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/1a6ad157f55bc42b548df.png"
          alt="logo"
        />
        <a href="https://t.me/MOVIES_ZILAA">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/8769Anurag/Anurag"><i class="fab fa-github"></i></a>
        <a href="https://t.me/MOVIES_ZILAA"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
@app.route('/')
def homepage():
    return "<h1>See mirror-with-weeb <a href='https://github.com/8769Anurag/8769Anurag'>@GitHub</a> By <a href='https://github.com/8769Anurag'>Code With Weeb</a></h1>"
